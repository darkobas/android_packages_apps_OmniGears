...
public class CyanoColorPickerPreference extends Preference implements DialogInterface.OnDismissListener {

    private static String TAG = "CyanoColorPickerPreference";
     ...
     * @param attrs
     */
    public CyanoColorPickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mColorValue = DEFAULT_COLOR;
        init();
    }

    public CyanoColorPickerPreference(Context context, int color) {
        super(context, null);
        mColorValue = color;
        init();
    }
    ...
    public Dialog getDialog() {
        final CyanoColorPickerDialog d = new CyanoColorPickerDialog(getContext(), mColorValue);
