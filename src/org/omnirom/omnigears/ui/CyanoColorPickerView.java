 ...
 */
public class CyanoColorPickerView extends View {
    ...
    public CyanoColorPickerView(Context context) {
        this(context, null);
    }

    public CyanoColorPickerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CyanoColorPickerView(Context context, AttributeSet attrs, int defStyle) {
