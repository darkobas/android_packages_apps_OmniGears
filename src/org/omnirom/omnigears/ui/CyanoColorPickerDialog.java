...
import org.omnirom.omnigears.ui.CyanoColorPanelView;
import org.omnirom.omnigears.ui.CyanoColorPickerView;
import org.omnirom.omnigears.ui.CyanoColorPickerView.OnColorChangedListener;

import java.util.ArrayList;
import java.util.IllegalFormatException;
import java.util.Locale;

public class CyanoColorPickerDialog extends AlertDialog implements
        CyanoColorPickerView.OnColorChangedListener, TextWatcher, OnFocusChangeListener {

    private static final String TAG = "CyanoColorPickerDialog";
    private final static String STATE_KEY_COLOR = "CyanoColorPickerDialog:color";

    private CyanoColorPickerView mColorPicker;

    private EditText mHexColorInput;
    private CyanoColorPanelView mNewColor;
    private LayoutInflater mInflater;
    private boolean mMultiColor = true;
    private LinearLayout mColorPanelView;

    public CyanoColorPickerDialog(Context context, int initialColor) {
        super(context);
    ...
    private void setUp(int color) {
        ...
        View layout = mInflater.inflate(R.layout.dialog_cyano_color_picker, null);

        mColorPicker = (CyanoColorPickerView) layout.findViewById(R.id.color_picker_view);
        mHexColorInput = (EditText) layout.findViewById(R.id.hex_color_input);
        mNewColor = (CyanoColorPanelView) layout.findViewById(R.id.color_panel);
